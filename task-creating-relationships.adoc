...
* https://docs.netapp.com/us-en/storage-management-azure-netapp-files/task-quick-start.html[Setting up and discovering Azure NetApp Files^]
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-adding-systems.html[Adding existing Cloud Volumes ONTAP systems^]
* https://docs.netapp.com/us-en/storage-management-ontap-onprem/task-discovering-ontap.html[Discovering ONTAP clusters^]
...
+
Schedule:: Choose a recurring schedule for future syncs or turn off the sync schedule. You can schedule a relationship to sync data as often as every 1 minute. Schedules can also be set at hourly and daily frequencies. 
+
include::_include/utc-time.adoc[]
...
Copy and Sync starts syncing data between the source and target. Sync statistics on how long the sync took, whether it halted, and how many files were copied, scanned, or deleted are available. You can then manage your link:task-managing-relationships.html[sync relationships], link:task-managing-data-brokers.html[manage your data brokers], or link:task-managing-reports.html#creating-reports[create reports to optimize your performance and configuration].
...
https://docs.netapp.com/us-en/data-services-data-classification/concept-classification.html[Learn how to start a sync relationship from NetApp Data Classification^].
