...
Copy and Sync starts syncing data between the source and target. Sync statistics on how long the sync took, whether it halted, and how many files were copied, scanned, or deleted are available. You can then manage your https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-relationships.html[sync relationships], https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-data-brokers.html[manage your data brokers], or https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-reports.html#creating-reports[create reports to optimize your performance and configuration].
