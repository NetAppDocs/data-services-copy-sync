...
= Technical FAQ for NetApp Copy and Sync
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* https://marketplace.microsoft.com/en-us/product/netapp.cloud-sync-service?tab=PlansAndPrice[View pricing in Azure^]
