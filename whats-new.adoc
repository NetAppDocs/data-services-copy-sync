...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-linux.html#linux-host-requirements[View Linux host requirements].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#create-other-types-of-sync-relationships[Learn more about the *Exclude Directories* feature.]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html[Learn more about creating a sync relationship.]

=== Support for Tel Aviv region in AWS data brokers

Tel Aviv is now a supported region when creating a data broker in AWS.

https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-aws.html#creating-the-data-broker[Learn more about creating a data broker in AWS].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#create-other-types-of-sync-relationships[Learn more about the *Exclude File Extensions* feature.]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-azure.html#creating-the-data-broker[Learn more about creating a data broker in Azure.]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-azure.html[Learn more about creating a data broker in Azure.]
...
https://docs.netapp.com/us-en/data-services-copy-sync/reference-requirements.html#google-cloud-storage-bucket-requirements[Learn more about Google Cloud Storage bucket requirements.]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-relationships.html#deleting-relationships[Learn more about deleting sync relelationships.]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-copying-acls.html[Learn more about copying ACLs.]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings[Learn more about the Sync Timeout setting].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings[Learn more about the Copy For Objects setting].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings[Learn more about the File Types setting].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings[Learn more about the Recently Modified Files setting].
...
https://docs.netapp.com/us-en/data-services-copy-sync/api-sync.html[Learn more about using the RESTful API with NetApp Copy and Sync].

https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings[Learn more about the Exclude Directories setting].
...
https://docs.netapp.com/us-en/data-services-copy-sync/reference-supported-relationships.html[Learn more about supported sync relationships].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-aws.html#details-about-the-data-broker-instance[Learn more about the data broker instance in AWS].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-data-brokers.html[Learn more about managing data broker groups].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-azure.html#details-about-the-data-broker-vm[Learn more about the data broker instance in Azure].

https://docs.netapp.com/us-en/data-services-copy-sync/task-installing-gcp.html#details-about-the-data-broker-vm-instance[Learn more about the data broker instance in Google Cloud].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings[Learn more about the Exclude Directory Names setting].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-creating-relationships.html#settings[Learn more about the Continuous Sync setting].
...
+
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-reports.html[Learn more about reports].
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-relationships.html#setting-up-notifications[Learn how to set up notifications].
...
Before you can create a sync relationship that includes Google Drive, you need to set up a service account that has the required permissions and a private key. https://docs.netapp.com/us-en/data-services-copy-sync/reference-requirements.html#google-drive[Learn more about Google Drive requirements].

https://docs.netapp.com/us-en/data-services-copy-sync/reference-supported-relationships.html[View the list of supported sync relationships].
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-enable-drag-and-drop.png[A screenshot that shows the Notification Center in the NetApp Console.]
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-enable-panel.png[A screenshot that shows the Notification Center in the NetApp Console.]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-relationships.html#change-the-settings-for-a-sync-relationship[Learn more about changing the settings for a sync relationship].
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-notification-center.png[A screenshot that shows the Notification Center in the NetApp Console.]
...
https://docs.netapp.com/us-en/data-services-copy-sync/task-managing-data-brokers.html[Learn how to manage data broker groups].
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-sync-filter.png[A screenshot that shows the Filter by sync status option at the top of the dashboard.]
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-sync-sort.png[A screenshot that shows the Sort by name option that is available from the dashboard.]
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-sync-data-sense.png[A screenshot that shows the Data Sense Integration page that appears after starting a new sync directly from Cloud Data Sense.]
...
image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-sync-select-data-broker-group.png[A screenshot of the Sync Relationship wizard that shows the data broker group selection.]

In the *Manage Data Brokers* tab, we also show the number of sync relationships that a data broker group is managing.

image:https://raw.githubusercontent.com/NetAppDocs/data-services-copy-sync/main/media/screenshot-sync-group-relationships.png["A screenshot of the Manage Data Brokers page that shows a data broker group and details about that group, including the number of relationships that it's managing."]
...
* https://docs.netapp.com/us-en/storage-management-fsx-ontap/start/concept-fsx-aws.html[Learn about Amazon FSx for ONTAP^]
